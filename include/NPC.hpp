...
class NPC : public Player {
    private:
        ...
        NPC(std::string name, std::string spriteLocation, std::string animationsLocation, int LVL, int STR, int VIT, int MAG, int AGI, int LU, int baseXPAmount, std::map<std::string, float> affinities, bool isBoss = true, const std::vector<std::string>& skills = {}); //boss constructor, only they have animations for my own sanity
        ~NPC();
        int getBaseXPAmount() const;
        std::string getAnimationsLocation() const;
